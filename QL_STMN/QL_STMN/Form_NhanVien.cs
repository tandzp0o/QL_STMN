...
namespace QL_STMN
{
    public partial class Form_NhanVien : Form
    {
        ...
        {
            Form_ReportNhanVien formReportViewer = new Form_ReportNhanVien();
            formReportViewer.SearchName = txtSearchName.Text.Trim();
            formReportViewer.SearchChucVu = comboBox_SearchChucVu.SelectedValue?.ToString().Trim();
